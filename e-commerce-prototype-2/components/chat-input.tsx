  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        "focus-within:border-[#D4AF37]/30 focus-within:shadow-[0_0_0_2px_rgba(212,175,55,0.08)]",
        isDragOver 
        ...
        <textarea
          ...
          className={cn(
            ...
            "focus:outline-none focus:ring-0 outline-none font-sans leading-[1.5] py-2 resize-none"
          )}
          style={{
            maxHeight: 160,
            overflowY: "auto",
